...
import { Plus, Pencil, Trash2, Film, ArrowLeft, X, Users, CreditCard, Shield, Ban, Unlock, DollarSign, Check, XCircle, Image, MessageSquare, SkipForward, Layers, Megaphone } from 'lucide-react';
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      {!form.has_episodes && (
                        <div className="space-y-2">
                          ...
                          <Input type="file" accept="video/*" onChange={e => handleFileUpload(e, 'videos', 'video', 'video_url', 'video_filename')} disabled={uploading} />
                      ...
                      {form.ad_enabled && (
                        <div className="space-y-4">
                          <div className="space-y-2">
                            ...
                            <Input type="file" accept="video/*" onChange={e => handleFileUpload(e, 'videos', 'ad', 'ad_video_url', 'ad_video_filename')} disabled={uploading} />
